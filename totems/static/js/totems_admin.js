...
$(document).ready(function() {
    ...
    $('body').on("click",'#apitester_register',function() {
        var secret_params = Array()
        secret_params[0] = "device_id";
        secret_params[1] = "registration_longitude";
        secret_params[2] = "registration_latitude";
        secret_params[3] = "timestamp";
        testapi("api/register/",secret_params)
    });
    ...
    $('body').on("click",'#apitester_add_totem',function() {
        var secret_params = Array()
        secret_params[0] = "device_id";
        secret_params[1] = "longitude";
        secret_params[2] = "latitude";
        secret_params[3] = "timestamp";
        testapi("api/add_totem/",secret_params)
    });
    ...
    $('body').on("click",'#apitester_add_reply',function() {
        var secret_params = Array();
        secret_params[0] = "device_id";
        secret_params[1] = "parent_message_id";
        secret_params[2] = "timestamp";
        testapi("api/add_reply/",secret_params)
    });
    ...
    $('body').on("click",'#apitester_fetch_totems',function() {
        ...
        secret_params[2] = "latitude";
        secret_params[3] = "timestamp";
        testapi("api/fetch_totems/",secret_params)
    });
    ...
    $('body').on("click",'#apitester_fetch_messages',function() {
        ...
        secret_params[2] = "latitude";
        secret_params[3] = "timestamp";
        testapi("api/fetch_messages/",secret_params)
    });
    ...
    $('body').on("click",'#apitester_fetch_totem_thread',function() {
        ...
        secret_params[1] = "parent_message_id";
        secret_params[2] = "timestamp";
        testapi("api/fetch_totem_thread/",secret_params)
    });

    // TOGGLE FLAG
    $('body').on("click",'#apitester_toggle_flag',function() {
        var secret_params = Array();
        secret_params[0] = "device_id";
        secret_params[1] = "message_id";
        secret_params[2] = "timestamp";
        testapi("api/toggle_flag/",secret_params)
    });
    ...
    $('body').on("click",'#simulate_fetch',function() {
        ...
        ajax("api/fetch_totems/",data,secret_params, function(response) {
    ...
    $('body').on("click",".action_delete_message", function() {
        ...
        ajax("panel/messages/delete/"+message_id+"/",data,Array(),function (response) {
...
function testapi(url,secret_params) {
    ...
    ajax(url,data,secret_params,function(response) {
...
function ajax(url, data, secret_params,success) {
    
    data['timestamp'] = Math.round(new Date().getTime() / 1000);
    var secret = ""

    for (var i = 0; i < secret_params.length; i++) {
        secret += String(data[secret_params[i]]);
    }

    secret += totems_secret;
    data['secret'] = SHA256(secret);
